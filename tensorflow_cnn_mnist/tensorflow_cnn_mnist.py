# Wu,Wenbo (8930231)
# March 1, 2018
# Adapted form on the MNIST expert tutorial by Google.
# Used for ELG5378 assignment to implement a CNN model based on MNIST database 
# for handwriting digit recognition.
